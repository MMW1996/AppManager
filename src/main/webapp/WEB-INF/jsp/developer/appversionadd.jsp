    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
			...
			<div class="row" id="versionrow">
				<div class="col-sm-12">
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
						...
						<tbody>
                                    <tr v-if="versionLength==0">
                                        <td colspan="6" style="font-size:28px;color:red" align="center">
                                            暂无数据
                                        </td>
                                    </tr>
                                    <tr role="row" class="odd" v-else v-for="item in versions">
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="<%=request.getContextPath()%>/addVersion" method="post" enctype="multipart/form-data">
...
<script>
    $(function () {
        ...
        $.getJSON('<%=request.getContextPath()%>/versionHistory',{"appId":appId},function (data) {
            const versions = data;
            console.log("历史版本信息:" + versions);
            console.log("历史版本信息:" + versions.length);
            const app = new Vue({
                el:"#versionrow",
                data:{
                    versions:versions
        ...
        $("#back").click(function (){
            location.href = '<%=request.getContextPath()%>/jsp/developer/appinfolist.jsp';
        })
    })
</script>
