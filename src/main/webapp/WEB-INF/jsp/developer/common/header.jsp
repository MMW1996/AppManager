            ...
            <div class="left_col scroll-view">
                ...
                <div id="sidebar-menu"
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-apple"></i> APP应用管理<span
                                    class="fa fa-chevron-down"></span>
                            </a>
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath }/link/toList">APP维护</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="sidebar-footer hidden-small">
                    ...
                    <span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
                        ...
                        href="javascript:if(confirm('are you sure')) location.href = '${pageContext.request.contextPath}/logout'"> <span
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class=""><a href="javascript:;"
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li>
                                    <a href="#">
                                        <i class="fa fa-sign-in pull-right"></i>销户
                                    </a>
                                </li>
                            </ul>
                        </li>
